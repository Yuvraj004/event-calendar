var cal = {
  ...
  // (H) BACKGROUND IMAGES FOR CALENDAR
  img : (mth) => {
    if( mth==1 || mth==2 ) {
      document.body.style.background = " url('./static/img/spring.jpg') no-repeat";
      document.body.style.backgroundSize = "cover";
    };
    if(mth==11 || mth==0 || mth==10 || mth==9) {
      document.body.style.background = " url('./static/img/winter.jpg') no-repeat center ";
      document.body.style.backgroundSize = "cover";
    };
    if(mth==3 || mth==4 || mth==5 || mth==6 ) {
      document.body.style.background = " url('./static/img/summer.jpg') no-repeat";
      document.body.style.backgroundSize = "cover";
    };
    if( mth==7 || mth==8 ) {
      document.body.style.background = " url('./static/img/autumn.jpg') no-repeat  ";
      document.body.style.backgroundSize = "cover";
    };
  }
